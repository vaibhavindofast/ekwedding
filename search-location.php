    ...
    <section class="search-result-header">
        <div class="container">
            ...
            <div class="view-by">
                ...
                <a href="javascript:" class="selected-tags">Patna <span>X</span></a>
                <a href="javascript:" class="selected-tags">Boring Road <span>X</span></a>
                                        ...
                                        <div>                                        
                                            <div class="inner">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><a href="event-detail.php">Barn & Farm Weddings</a></li>
                                    ...
                                    <div class="collapse show" id="city">
                                        <div>                                        
                                            <div class="inner">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><a href="event-detail.php">Patna</a></li>
                                                    <li><a href="javascript:">Gaya</a></li>
                                                    <li><a href="javascript:">Muzaffarpur</a></li>
                                                    <li><a href="javascript:">Samastipur</a></li>
                                                    <li><a href="javascript:">Bihar Sharif</a></li>
                                                    <li><a href="javascript:">Bihta</a></li>
                                                    <li><a href="javascript:">Sasaram</a></li>
                                                </ul>
                                                <div class="view-all">
                                                    <a href="javascript:" class="btn btn-link-default p-0">+ View More</a>
                                                </div>
                            ...
                            <div class="tab-pane fade active show" id="pills-listing" role="tabpanel" aria-labelledby="pills-listing-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="img">
                                                ...
                                                <a href="event-detail.php"><img src="assets/images/wedding_listing_1.jpg" alt="" class="rounded"></a>
                                            </div>                                    
                                        </div>
                                        <div class="col-md-8">
                                            <div class="content">
                                                <div class="head">
                                                    ...
                                                    <h3><a href="event-detail.php">Lotus Wedding Florist</a></h3>
                                                    <div class="rating">
                                                        <span class="stars">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                        ...
                                                        (22 review)  /  Patna, Bihar, India
                                                    </div>
                                                </div>
                                                <p>Nullam facilisis massa id elit ornare lobortised convallis purus ac tincidunt </p>
                                                <div class="bottom">
                                                    <span class="badge border rounded p-2">Guests 1 to 200</span>
                                                    <a href="event-detail.php" class="btn btn-outline-primary btn-rounded" data-toggle="modal" data-target="#request_quote">View More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="img">
                                                ...
                                                <a href="javascript:"><img src="assets/images/wedding_listing_2.jpg" alt="" class="rounded"></a>
                                            </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="content">
                                                ...
                                                <div class="bottom">
                                                    <span class="badge border rounded p-2">Guests 1 to 200</span>
                                                    <a href="javascript:" class="btn btn-outline-primary btn-rounded" data-toggle="modal" data-target="#request_quote">View More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="result-list">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="img">
                                                <a href="javascript:"><img src="assets/images/wedding_listing_3.jpg" alt="" class="rounded"></a>
                                            </div>                                    
                                        </div>
                                        <div class="col-md-8">
                                            <div class="content">
                                ...
                                <div class="result-list">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="img">
                                                <a href="javascript:"><img src="assets/images/wedding_listing_1.jpg" alt="" class="rounded"></a>
                                            </div>
                                        ...
                                        <div class="wedding-listing">
                                            ...
                                            <div class="content">
                                                <div class="gap">
                                                    ...
                                                    <div class="text-white"><i class="fa fa-map-marker"></i> Patna, Bihar, India</div>
                                                </div>
                                                <div class="reviews">
                                                    <span class="stars">
                                                        <i class="fa fa-star"></i>
