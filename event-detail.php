            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane show active" id="pills-hr-grid" role="tabpanel" aria-labelledby="pills-hr-grid-tab">
                    <div class="owl-carousel owl-theme" id="slider-vendor-single">                        
                        <!-- About Slider Images -->
                        <div class="item" style="background-image: url(assets/images/vendor_slider_1.jpg);">
                            
                        </div>
                        <!-- About Slider Images -->
        
                        <!-- About Slider Images -->
                        <div class="item" style="background-image: url(assets/images/vendor_slider_2.jpg);">
                            
                        </div>
                        <!-- About Slider Images -->
        
                        <!-- About Slider Images -->
                        <div class="item" style="background-image: url(assets/images/vendor_slider_3.jpg);">
                ...
                <div class="tab-pane" id="pills-map" role="tabpanel" aria-labelledby="pills-map-tab">
                    <div class="slider-frame">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115132.86107261921!2d85.07300207866918!3d25.608175570214517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f29937c52d4f05%3A0x831a0e05f607b270!2sPatna%2C%20Bihar!5e0!3m2!1sen!2sin!4v1668798522271!5m2!1sen!2sin" width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6 mb-0">
                        <div class="profile-single">
                            <h3>Sagun Banquet Hall</h3>
                            <p><i class="fa fa-map-marker"></i>  Exhibition Road, Patna</p>
                            <div class="reviews">
                                <span class="badge"><i class="fa fa-star-half-full"></i> 4.2</span> 8 Reviews
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 text-lg-right mt-lg-0 mt-4">
                        ...
                        <a href="javascript:" class="btn btn-primary mb-2"><i class="fa fa-check"></i> Verified</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-shadow-body">
                                <div class="row vendor-img-gallery">
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendor_img_1.jpg" title="Title come here">
                                                <img src="assets/images/vendor_img_1.jpg" class="rounded" alt="">
                                            </a>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendor_img_2.jpg" title="Title come here">
                                                <img src="assets/images/vendor_img_2.jpg" class="rounded" alt="">
                                            </a>  
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendor_img_3.jpg" title="Title come here">
                                                <img src="assets/images/vendor_img_3.jpg" class="rounded" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-0">
                                        <div class="vendor-gallery">
                                            <a href="assets/images/vendor_img_4.jpg" title="Title come here">
                                                <img src="assets/images/vendor_img_4.jpg" class="rounded" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div id="vendor-img-gallery">
                                    <div class="row vendor-img-gallery">                                       
                                        <div class="col-md-3 mb-0">
                                            <div class="vendor-gallery">
                                                <a href="assets/images/vendor_img_5.jpg" title="Title come here">
                                                    <img src="assets/images/vendor_img_5.jpg" class="rounded" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-0">
                                            <div class="vendor-gallery">
                                                <a href="assets/images/vendor_img_6.jpg" title="Title come here">
                                                    <img src="assets/images/vendor_img_6.jpg" class="rounded" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-0">
                                            <div class="vendor-gallery">
                                                <a href="assets/images/vendor_img_7.jpg" title="Title come here">
                                                    <img src="assets/images/vendor_img_7.jpg" class="rounded" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-shadow-body">
                                <div class="vendor-video">
                                    <a class="popup-video" href="http://www.youtube.com/watch?v=0O2aH4XLbto">
                                        ...
                                        <img src="assets/images/vendor_video.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <aside class="row sidebar-widgets">
                            ...
                            <div class="sidebar-primary col-lg-12 col-md-6">
                                ...
                                <!-- Widget Wrap -->
<div class="widget">
<h3 class="widget-title">Check Availability</h3>
<div class="request-quote-form">
<div class="form-group">
<select class="form-light-select theme-combo" name="state">
<option seected value='1'>--Select Month--</option>
<option seected value='1'>Janaury</option>
...
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">2 </a>
</div>
</div>

<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<div class="color-bg bg-red">10</div>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">14 </a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<div class="color-bg bg-red">18</div>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">21 </a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">22 </a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">23 </a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<div class="color-bg bg-red">24</div>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">24 </a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">28</a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<a href="book-now.php" title="book now" class="color-bg bg-green text-center">30 </a>
</div>
</div>
<div class="col-lg-2 col-sm-6 col-6">
<div class="color-pallete-box d-flex align-items-center mb-0">
<div class="color-bg bg-red">31</div>
</div>
</div>
                            ...
                            <div class="sidebar-secondary col-lg-12 col-md-6">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="icon-box-style-3 sided mt-3 mb-0">
                                        ...
                                        <span> <a href="javascript:" class="btn-link btn-link-secondary">info@rameshsharma.com</a> </span>
                                    </div>

                                    <div class="icon-box-style-3 sided mt-3 mb-0">
                                        <i class="fa fa-phone"></i>
                                        <span> <a href="javascript:" class="btn-link btn-link-secondary">https://eventekwedding.com</a> </span>
                                    </div>
                                    ...
                                    <div class="owl-carousel owl-theme" id="wedding-listing-single">                        
                                        ...
                                        <div class="item">
                                            <div class="wedding-listing">
                                                <div class="img">
                                                    <a href="javascript:">
                                                        <img src="assets/images/wedding_listing_1.jpg" alt="">                                                    
                                                    </a>
                                                ...
                                                <div class="content">
                                                    <div class="gap">
                                                        <h3><a href="#">Party Point Darwar <span class="verified"><i class="fa fa-check-circle"></i></span></a></h3>
                                                        <div class="text-light"><i class="fa fa-map-marker"></i> Patna, Bihar, India</div>
                                                    </div>
                                                    <div class="reviews">
                                                        <span class="stars">
                                                            <i class="fa fa-star"></i>
                                        ...
                                        <div class="item">
                                            <div class="wedding-listing">
                                                <div class="img">
                                                    <a href="javascript:">
                                                        <img src="assets/images/wedding_listing_2.jpg" alt="">
                                                    </a>
                                                    <div class="img-content">
                                                       <div class="bottom">
                                                ...
                                                <div class="content">
                                                    <div class="gap">
                                                        <h3><a href="#">A One Banquet <span class="verified"><i class="fa fa-check-circle"></i></span></a></h3>
                                                        <div class="text-light"><i class="fa fa-map-marker"></i> Patna, Bihar, India</div>
                                                    </div>
                                                    <div class="reviews">
                                                        <span class="stars">
                                        ...
                                        <div class="item">
                                            <div class="wedding-listing">
                                                <div class="img">
                                                    <a href="javascript:">
                                                        <img src="assets/images/wedding_listing_3.jpg" alt="">
                                                    </a>
                                                ...
                                                <div class="content">
                                                    <div class="gap">
                                                        <h3><a href="#">Raj Darwar <span class="verified"><i class="fa fa-check-circle"></i></span></a></h3>
                                                        <div class="text-light"><i class="fa fa-map-marker"></i> Patna, Bihar, India</div>
                                                    </div>
                                                    <div class="reviews">
                                                        <span class="stars">
